...
logging.basicConfig(level=logging.DEBUG, filename='ansi.log', filemode='a')
ignoreText = False
...
class ANSI (term):
    ...
    def __init__ (self, r=24,c=80):
        ...
        self.state.set_default_transition (Emit, 'INIT')
        self.state.add_transition_any ('INIT', Emit, 'INIT')
        self.state.add_transition ('\x1b', 'INIT', HandleEsc, 'ESC')
        ...
        self.state.add_transition ('c', 'ELB', DoReset, 'INIT')
...
#RM   Reset Mode                Esc [ Ps l                   none
        ...
        ###DAP - Code to support a third number, BIOS does this
        self.state.add_transition (';', 'NUMBER_2', None, 'SEMICOLON2')
        self.state.add_transition_list (string.digits, 'SEMICOLON2', StartNumber, 'NUMBER_3')
        self.state.add_transition_list (string.digits, 'NUMBER_3', BuildNumber, 'NUMBER_3')
        self.state.add_transition ('m', 'NUMBER_3', None, 'INIT')
